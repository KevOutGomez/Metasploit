...
* **Exploit local**: Este tipo de exploits funcionan en un sistema al cual nosotros tenemos acceso fisico.
...
* **Payload**: Es una pieza de código que se ejecuta después de que hemos explotado la vulnerabilidad de un sistema. Básicamente define el tipo de acceso y las acciones que haremos cuando estamos dentro del sistema.
